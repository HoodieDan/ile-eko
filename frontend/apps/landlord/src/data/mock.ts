...
export const activityLog: ActivityEntry[] = [
  {
    ...
    initials: 'MI',
    type: 'payment',
    action: 'Logged ₦1,500,000 rent payment',
    detail: 'Flat 1, Harmony Court · Magodo',
    when: 'Today, 09:24',
    ago: '2h ago',
    propertyId: 'p6',
  },
  {
    ...
    initials: 'MI',
    type: 'payment',
    action: 'Logged ₦750,000 part-payment',
    detail: 'Flat 2, Harmony Court · Magodo',
    when: 'Today, 08:55',
    ago: '3h ago',
    propertyId: 'p6',
    flag: 'Payment logged without a receipt upload — review.',
  },
  {
    id: 'a3',
    who: 'Musa Ibrahim',
    initials: 'MI',
    type: 'image',
    action: 'Uploaded 4 inspection photos',
    detail: '5 Diya Street · Gbagada',
    when: 'Today, 08:10',
    ago: '4h ago',
    propertyId: 'p5',
  },
  {
    ...
    initials: 'MI',
    type: 'maintenance',
    action: 'Logged a plumbing repair',
    detail: '8 Herbert Macaulay Way · Yaba',
  ...
  },
  {
    ...
    initials: 'MI',
    type: 'status',
    action: 'Marked Flat 3 as vacant',
    detail: 'Harmony Court · Magodo',
  ...
  },
  {
    ...
    initials: 'BO',
    type: 'tenant',
    action: 'Added tenant Adebayo Williams',
    detail: '14 Admiralty Way · Lekki Phase 1',
    when: 'Yesterday, 11:30',
    ago: '1d ago',
    propertyId: 'p1',
    flag: 'Tenant added before lease document uploaded.',
  },
  {
    id: 'a7',
    who: 'Musa Ibrahim',
    initials: 'MI',
    type: 'payment',
    action: 'Confirmed ₦450,000 cash receipt',
    detail: '22 Bode Thomas · Surulere',
    when: '2 Jun, 17:20',
    ago: '2d ago',
    propertyId: 'p4',
  },
  {
    ...
    initials: 'MI',
    type: 'status',
    action: 'Updated occupancy to occupied',
    detail: '12B Raymond Njoku · Ikoyi',
    when: '1 Jun, 10:02',
    ago: '3d ago',
    propertyId: 'p2',
  },
...
export const notifications: NotificationItem[] = [
  {
    ...
    type: 'overdue',
    title: 'Rent overdue',
    body: 'Tunde Akinola is 14 days late on ₦1,200,000 — Yaba.',
    when: '09:10',
    group: 'Today',
    read: false,
    propertyId: 'p3',
  },
  {
    id: 'n2',
    type: 'activity',
    title: 'Caretaker logged a payment',
    body: 'Musa Ibrahim logged ₦1,500,000 for Flat 1, Harmony Court.',
    when: '09:24',
    group: 'Today',
    read: false,
    propertyId: 'p6',
  },
  {
    id: 'n3',
    type: 'ai',
    title: 'AI flagged an action',
    body: 'A part-payment was logged without a receipt — review.',
    when: '08:55',
    group: 'Today',
    read: false,
    propertyId: 'p6',
  },
  {
    ...
    type: 'rent-due',
    title: 'Rent due soon',
    body: "Ngozi Eze's ₦450,000 is due in 21 days — Surulere.",
    when: '08:00',
    group: 'Today',
    read: true,
    propertyId: 'p4',
  },
  {
    ...
    body: 'Musa Ibrahim added 4 photos for 5 Diya Street, Gbagada.',
    when: 'Yesterday',
    group: 'Yesterday',
    read: true,
    propertyId: 'p5',
  },
  {
    ...
    body: "Chinedu Okafor's lease in Lekki ends in 30 days.",
    when: 'Yesterday',
    group: 'Yesterday',
    read: true,
    propertyId: 'p1',
  },
  {
    ...
    type: 'lease',
    title: 'Lease expiring',
    body: "Tunde Akinola's lease in Yaba ends in 16 days.",
    when: 'Mon',
    group: 'Earlier',
    read: true,
    propertyId: 'p3',
...
export const enquiries: Enquiry[] = [
  {
    ...
    propertyId: 'p5',
    area: 'Gbagada',
    snippet: 'Is the 3-bedroom still available? I can move in by end of June…',
    message:
      "Good day. I saw your 3-bedroom flat at 5 Diya Street on the Ilé Èkó marketplace. Is it still available? I can move in by the end of June and I'm happy to pay annually. Please let me know the next steps.",
    when: '1h ago',
    group: 'Today',
    read: false,
  },
  {
    ...
    propertyId: 'p5',
    area: 'Gbagada',
    snippet: 'Please can I schedule an inspection this Saturday?',
    message:
      "Hello, I'm interested in the Gbagada flat. Can I schedule an inspection this Saturday morning? Thank you.",
    when: '3h ago',
    group: 'Today',
    read: false,
  },
  {
    ...
    propertyId: 'p6',
    area: 'Magodo',
    snippet: 'Is Flat 3 furnished? Is the rent negotiable for 2 years?',
    message:
      'Good afternoon. Is Flat 3 at Harmony Court furnished? Also, is the ₦2,000,000 rent negotiable if I take a 2-year lease?',
    when: 'Yesterday',
    group: 'Yesterday',
    read: true,
  },
  {
    ...
    propertyId: 'p5',
    area: 'Gbagada',
    snippet: 'Does the compound have a borehole and parking?',
    message: 'Hi, does 5 Diya Street have a borehole and dedicated parking? I have two cars.',
    when: 'Yesterday',
    group: 'Yesterday',
    read: true,
  },
  {
    ...
    propertyId: 'p6',
    area: 'Magodo',
    snippet: 'I submitted my application — any update?',
    message:
      "Hello, I submitted my application for Flat 3 last week and I'm ready to pay a deposit. Any update on my request?",
    when: 'Mon',
    group: 'Earlier',
    read: true,
  },
...
export const enquiriesForProperty = (pid: string): Enquiry[] =>
  enquiries.filter((e) => e.propertyId === pid);
...
export const tenants: Tenant[] = [
  {
    ...
    area: 'Lekki Phase 1',
    type: '3-bed flat',
    leaseStart: '10 Mar 2025',
    leaseEnd: '09 Mar 2026',
    moveIn: '12 Mar 2025',
    rent: 2500000,
    schedule: 'Annual',
    status: 'paid',
    risk: { level: 'Low', reason: '5 on-time payments, never late.' },
    history: [
      {
        period: '2025 – 2026 rent',
        amount: 2500000,
        date: '10 Mar 2025',
        state: 'confirmed',
  ...
  },
  {
    ...
    initials: 'FA',
    phone: '0817 ••• 9203',
    email: 'funke.adeyemi@yahoo.com',
    propertyId: 'p2',
    unit: null,
    area: 'Ikoyi',
    type: '4-bed duplex',
    leaseStart: '28 Jul 2025',
    leaseEnd: '27 Jul 2026',
    moveIn: '01 Aug 2025',
    rent: 4500000,
    schedule: 'Annual',
    status: 'paid',
    risk: { level: 'Low', reason: 'Long-standing tenant since 2022, always pays in advance.' },
    history: [
      {
        period: '2025 – 2026 rent',
        amount: 4500000,
  ...
  },
  {
    ...
    initials: 'TA',
    phone: '0809 ••• 1182',
    email: 'tunde.akinola@gmail.com',
    propertyId: 'p3',
    unit: null,
    area: 'Yaba',
    type: '2-bed flat',
    leaseStart: '19 May 2025',
    leaseEnd: '18 May 2026',
    moveIn: '20 May 2024',
    rent: 1200000,
    schedule: 'Annual',
    status: 'overdue',
    risk: { level: 'High', reason: '14 days overdue, 2 late payments in 12 months.' },
    history: [
      {
        period: '2025 – 2026 rent',
        amount: 1200000,
        date: 'Due 19 May 2026',
        state: 'overdue',
        method: '—',
      },
      {
        period: 'Jan 2026 part-payment',
        amount: 400000,
        date: '14 Jan 2026',
        state: 'partial',
        method: 'Cash',
  ...
  },
  {
    ...
    area: 'Surulere',
    type: 'Self-contain',
    leaseStart: '23 Jun 2025',
    leaseEnd: '22 Jun 2026',
    moveIn: '25 Jun 2023',
    rent: 450000,
    schedule: 'Annual',
    status: 'due',
    risk: { level: 'Watch', reason: 'Renewal due in 21 days; one late payment last year.' },
    history: [
      {
        period: '2025 – 2026 rent',
        amount: 450000,
        date: 'Due 23 Jun 2026',
        state: 'pending',
        method: '—',
      },
      {
  ...
  },
  {
    ...
    area: 'Magodo',
    type: '2-bed flat',
    leaseStart: '15 Sep 2025',
    leaseEnd: '14 Sep 2026',
    moveIn: '15 Sep 2025',
    rent: 1500000,
    schedule: 'Annual',
    status: 'paid',
  ...
  },
  {
    ...
    schedule: 'Bi-annual',
    status: 'partial',
    risk: { level: 'Watch', reason: 'Paid ₦750k of ₦1.5M; balance promised by month-end.' },
    history: [
      {
  ...
  },
  {
    ...
    area: 'Magodo',
    type: '2-bed flat',
    leaseStart: '03 Oct 2025',
    leaseEnd: '02 Oct 2026',
    moveIn: '03 Oct 2025',
    rent: 1500000,
    schedule: 'Annual',
    status: 'pending',
    risk: { level: 'Watch', reason: 'Bank transfer logged, awaiting confirmation.' },
    history: [
      {
        period: '2025 – 2026 rent',
        amount: 1500000,
...
export const tenantsForProperty = (pid: string): Tenant[] =>
  tenants.filter((t) => t.propertyId === pid);
